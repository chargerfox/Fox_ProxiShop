...
function format_text(input_string, italics_strings, flavour_index, is_centred) {
    ...
    for (i = 0; i < italics_indices.length; i++) {
        ...
        idRd = charIDToTypeID("Rd  ");
        desc127.putDouble(idRd, layer_text_colour.rgb.red);  // text colour.red
        idGrn = charIDToTypeID("Grn ");
        desc127.putDouble(idGrn, layer_text_colour.rgb.green);  // text colour.green
        idBl = charIDToTypeID("Bl  ");
        desc127.putDouble(idBl, layer_text_colour.rgb.blue);  // text colour.blue
        idRGBC = charIDToTypeID("RGBC");
    ...
    if (flavour_index > 0) {
        ...
        var lead = ($.global.ft_lead_global !== undefined && $.global.ft_lead_global !== null && $.global.ft_lead_global !== "")
			? Number($.global.ft_lead_global)
			: 4.4; // default seguro

		desc142.putUnitDouble(idspaceBefore, idPnt, lead);
