...
function read_csv(file) {
    ...
    for (var i = 0; i < lines.length; i++) {
        ...
        rows.push({
			...
			lang: cols[2] ? trim_str(cols[2]).toLowerCase() : "en",
			template: cols[3] ? trim_str(cols[3]) : "",
			collector: cols[4] ? trim_str(cols[4]) : ""
		});
...
function render(csv_file) {
    ...
    for (var i = 0; i < rows.length; i++) {
        ...
        // -----------------------------------
        // Armar argumento Python
        // name$set$collector$lang
        // -----------------------------------
