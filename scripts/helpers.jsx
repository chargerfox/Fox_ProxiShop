...
function get_legal_text(layout) {

    if (!layout.collector_number || !layout.set_total_count) {
        $.writeln("LEGAL: datos incompletos → collector=" + layout.collector_number + 
                  " total=" + layout.set_total_count);
        return "";
    }

    return layout.collector_number + "/" + layout.set_total_count;
}
